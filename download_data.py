...
if __name__ == "__main__":
    ...
    download_files_from_github_api("OpenLMLab", "GAOKAO-Bench", "Data/Objective_Questions", obj_dir)
    download_files_from_github_api("OpenLMLab", "GAOKAO-Bench", "Data/Subjective_Questions", sub_dir)
